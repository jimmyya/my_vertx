 ...
 * 不使用8080端口
 */
public class MyFirstVerticle3 extends AbstractVerticle {
    ...
    public void start(final Future<Void> fut) throws Exception {
        ...
        //设置访问到静态页面 将访问“/asserts/*”route到“asserts”目录资源
        router.route("/asserts/*").handler(StaticHandler.create("asserts"));
